#
#  Be sure to run `pod spec lint LFBR.SwiftLib.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/f3rn4d0n/LFBR-SwiftLib"
 ...
 spec.license      = { :type => "MIT", :file => "LICENSE" }
  ...
  spec.author             = { "Luis Fernando Bustos Ramírez" => "lufe.bura@gmail.com" }
  # Or just: spec.author    = "Luis Fernando Bustos Ramírez"
  # spec.authors            = { "Luis Fernando Bustos Ramírez" => "lufe.bura@gmail.com" }
   spec.social_media_url   = "https://twitter.com/fernandobustosr"
  ...
  spec.source       = { :git => "https://github.com/f3rn4d0n/LFBR-SwiftLib.git", :tag => "#{spec.version}" }
